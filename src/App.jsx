...
import FeatureMosaicGrid from './components/FeatureMosaicGrid';
        ...
        <Routes>
            <Route path="/" element={
                <div className="bg-dark-primary">
                    ...
                    <ParallaxSection id="features" ref={featuresRef} imageUrl={`${import.meta.env.BASE_URL}img/bg-grid.svg`} backgroundContent={<FeatureMosaicGrid />} gradientClass="bg-black/60">
                    ...
                    <ParallaxSection
                        id="p2p"
                        ref={p2pRef}
                        imageUrl={`${import.meta.env.BASE_URL}img/bg-p2p-network.svg`}
                            ...
                            >
                                ...
                                <div className="flex-shrink-0 relative group">
                                    ...
                                    <img
                                        ...
                                        style={{ maxWidth: '480px', aspectRatio: '3 / 2', objectFit: 'cover' }}
                                    />
                                </div>
                    ...
                    <section id="install" className="py-24 section-texture-primary">
                    ...
                    {/* ============== FAQ SECTION ============== */}
                    <section id="faq" className="py-24 section-texture-secondary">
                    ...
                    {/* ============== COMMUNITY & FOOTER ============== */}
                    <footer className="section-texture-primary border-t border-neutral-800">
